...
citations_rag_prompt = prompt = """Answer the query below and give information based on the provided documents.
...
questions_rag_prompt = prompt = """Answer the user's question based on the provided movies that are available on Hoopla, a streaming service.
